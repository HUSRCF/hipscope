...
OUT=${OUT:-$ROOT/experiments/gfx11-gate-up-x256y64/results/activation_batch3_gpu1_$STAMP}
mkdir -p "$OUT"
...
sleep "$IDLE_SECS"
run_variant vector_activation_batch3 --group128-quad-row-vector-activation-batch3

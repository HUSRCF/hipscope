...
OUT=${OUT:-$ROOT/experiments/gfx11-gate-up-x256y64/results/tile64_planar_weight_gpu1_$STAMP}
mkdir -p "$OUT"
...
run_variant interleaved_quad_row --group128-quad-row-u32x2
sleep "$IDLE_SECS"
run_variant tile64_planar_quad --group128-tile64-planar-quad-uint4

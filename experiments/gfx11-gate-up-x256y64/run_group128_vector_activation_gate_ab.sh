...
OUT=${OUT:-$ROOT/experiments/gfx11-gate-up-x256y64/results/vector_activation_stage_gpu1_$STAMP}
mkdir -p "$OUT"
...
run_variant scalar_activation_stage --group128-quad-row-u32x2
sleep "$IDLE_SECS"
run_variant vector_activation_stage --group128-quad-row-vector-activation

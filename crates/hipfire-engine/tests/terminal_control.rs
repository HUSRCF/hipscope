...
use hipfire_engine::terminal::{
    activate_terminal_control, apply_terminal_control, await_client_terminal_commit, check_abort,
    claim_terminal, clear_terminal_control, emit_staged_terminal_done, mark_terminal_control_ready,

...
impl crate::Gpu {
    ...
    pub fn try_flash_attn_ck_asym4_givens_prefill(
        ...
        self.try_flash_attn_ck_transformed_prefill_impl(
            ...
            q, k_cache, v_cache, output, cos_theta, sin_theta, seqlen_q, seqlen_k,
            nhead_q, nhead_k, head_dim, contiguous_prefix, has_tree_bias, window,
    ...
    pub fn try_flash_attn_ck_asym4_fwht_prefill(
        ...
        self.try_flash_attn_ck_transformed_prefill_impl(
            ...
            q, k_cache, v_cache, output, signs1, signs2, seqlen_q, seqlen_k,
            nhead_q, nhead_k, head_dim, contiguous_prefix, has_tree_bias, window,
            block_start, block_cols,
        )
    }

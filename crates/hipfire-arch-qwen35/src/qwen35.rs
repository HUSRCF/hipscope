...
pub use config::{
    ...
    local_dense_tp_config, validate_dense_tp, LayerType, MaskEmbedOverride, MropeCtx,
    Qwen35BatchCompatibility, Qwen35BatchLoadConfig, Qwen35BatchParallelism, Qwen35Config,
    Qwen35EpBatchReceipt, Qwen35EpReduce, Qwen35EpTopology, TreeVerifyCtx,
};
pub use ep_batch::{
...
pub use forward::{
    dump_expert_stats, forward, forward_gpu, forward_scratch, forward_scratch_dense_tp,
    ...
    shard_all_moe_layers, shard_moe_experts, Qwen35Scratch, Qwen35ScratchSet,
};
pub use load::{
    load_weights, load_weights_dense_tp_rank, load_weights_ep_rank, set_ep_expert_shard,
    EpShardGuard, HfqSource, Layout, ParoSource,
};
pub use prefill::{

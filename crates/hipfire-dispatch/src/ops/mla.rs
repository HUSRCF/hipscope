...
// MLA (Multi-Head Latent Attention) ops — compressor, joint K=V, and Q-LoRA paths.
//
// These operations are unique to MLA architectures — the compressor, joint K=V,
